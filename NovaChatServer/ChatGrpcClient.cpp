...
//bool ChatGrpcClient::GetBaseInfo(std::string base_key, int uid, std::shared_ptr<UserInfo>& userinfo) {
	...
	//if (b_base) {
	//	nlohmann::json root;
	//	root = nlohmann::json::parse(info_str);
	...
	//	std::cout << "user login uid is  " << userinfo->uid << " name  is " << userinfo->name << " pwd is " << userinfo->pwd << " email is " << userinfo->email << std::endl;
	//}
	//else {
	//	//redis中没有则查询mysql
	//	//查询数据库
	//	std::shared_ptr<UserInfo> user_info = nullptr;
	//	//user_info = SQLMgr::GetInstance()->GetUser(uid);
...
TextChatMsgRsp ChatGrpcClient::NotifyTextChatMsg(std::string server_ip, const TextChatMsgReq& req, const nlohmann::json& rtvalue) {
